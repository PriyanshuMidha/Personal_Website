...
import { adminMessageQuerySchema, updateMessageStatusSchema } from "../../validators/contactValidators.js";

const router = Router();

router.get("/", validate(adminMessageQuerySchema, "query"), listMessages);
